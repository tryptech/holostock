...
Filter by talent (with Japanese/English name matching in title and item), exclude digital items, preorders, and made-to-order items, sort by title/item/price/date. Data is built by a Node pipeline and updated automatically every hour via GitHub Actions.
